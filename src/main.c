...
#define F_CPU 16000000L //defines the cpu frequency, used in the ultil/delay.h file

//includes, files to include for basic and/or userful functions
...
int main(void) //the special main function, will be the first user defined code to run (usually)
{
	...
	while(1)
	{
		//main loop, will run after setup until power off, reset or an eventual interrupt (more on that later)
	}
}
