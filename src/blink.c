...
//as PORTA-PORTD pin numbers and arduino pin numbers do not match, see the help/arduino_layout.png file to know the port to pin correspondance for the ATMEGA328p (also with the capabilities of each pin)
